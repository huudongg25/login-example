...
function Login() {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post("http://localhost:8000/api/v1/user/login", dataLogin)
            .then((data) => {
            ...
            <div className='form'>
                ...
                <form className='form-group' onSubmit={handleSubmit}>
                    <div className="input-group">
                        ...
                        <input type="text" id='email' placeholder='Username' name='username' value={email} onChange={handleChangeInput} />
